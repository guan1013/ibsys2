...
public class PlanungstoolGUI {
	private static ResourceBundle BUNDLE = ResourceBundle
			.getBundle("de.hska.centurion.gui.i18n.messages"); //$NON-NLS-1$
	...
	private void calculateCapacity() {
		...
		try {
			...
			String message = "Die Kapazit�ten f�r Arbeitsplatz "
					+ e.getWorkplace() + "reicht nicht aus um " + e.getShifts()
					+ "Schichten und " + e.getOvertime()
					+ "Minuten �berstunden abzudecken.";
	...
	private void calculateSafetyStock() {
		...
		try {
			...
			String message = "Produkt " + e.getItem()
					+ " hat eine zu geringe Fixkosten abdeckung von "
					+ e.getFixCostCoverage()
					+ ". \n Es werden keine Produkte hiervon Produziert.";
			showErrorDialog(message, e, frameMain);
